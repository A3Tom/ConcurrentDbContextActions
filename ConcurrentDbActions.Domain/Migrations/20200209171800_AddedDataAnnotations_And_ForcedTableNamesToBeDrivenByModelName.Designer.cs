...
namespace ConcurrentDbActions.Domain.Migrations
{
    ...
    [Migration("20200209171800_AddedDataAnnotations_And_ForcedTableNamesToBeDrivenByModelName")]
    partial class AddedDataAnnotations_And_ForcedTableNamesToBeDrivenByModelName
    {
            ...
            modelBuilder.Entity("ConcurrentDbActions.Domain.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("710e5811-4102-4725-976c-65d3bc4c8bec"),
